...
require("native-geometry-prepare frame=[0-9]+ instances=[1-9][0-9]* main_vertices=[1-9][0-9]* mirror_vertices=[0-9]+ snapshot_ms=[0-9]+[.][0-9]+ resident_lookup_ms=[0-9]+[.][0-9]+ shadow_setup_ms=[0-9]+[.][0-9]+ main_ms=[0-9]+[.][0-9]+ mirror_ms=[0-9]+[.][0-9]+ completeness_ms=[0-9]+[.][0-9]+")
require("native GPU pipeline ready")
require("semantic asset mod native-world-test")
require("native texture override car[.]9[.]material[.]0 <- textures/terrain[.]png \\(64x32\\)")
...
foreach(limit 512 0 1)
    ...
    if(limit EQUAL 512)
        ...
        require("presentation-snapshot frame=[0-9]+ ready=1")
        require("vram-batch-sync copy=0 bytes=0")
        require("resident_draws=[1-9][0-9]* local_fallbacks=0")
        require("native-resident-upload vertices=[1-9][0-9]* indices=[0-9]+ source_vertices=[1-9][0-9]* bytes=[1-9][0-9]*")
