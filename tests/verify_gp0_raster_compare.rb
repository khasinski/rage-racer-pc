...
abort "raster report does not summarize recurring race regions" unless
  source.include?("region_rects") && source.include?("mirror_road:") &&
  source.include?("tachometer_needle:") && source.include?("largest_component:")
