...
get_filename_component(smoke_dir "${SMOKE}" DIRECTORY)
if(NOT EXISTS "${smoke_dir}/authored-cars/erriso_body.inc")
    message("SKIP: authored replacement cars are disabled in this build")
    return()
endif()
...
if(disc STREQUAL "")
    file(GLOB disc_candidates "${SOURCE}/disc/PAL/*.cue")
    list(LENGTH disc_candidates disc_candidate_count)
    if(disc_candidate_count GREATER 0)
        list(GET disc_candidates 0 disc)
    endif()
endif()
