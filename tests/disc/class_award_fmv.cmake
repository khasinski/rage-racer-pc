...
if(NOT CLASS MATCHES "^[0-5]$" OR NOT SERIES MATCHES "^[01]$" OR
   (CLASS EQUAL 5 AND SERIES EQUAL 0))
    message(FATAL_ERROR "Unsupported award fixture class/series")
endif()
math(EXPR stream "1 + ${SERIES} * 4 + ${CLASS}")
if(SERIES EQUAL 1 AND CLASS EQUAL 4)
    set(stream 8) # Shared-finale promotion reuses the last Extra class movie.
endif()
set(return_scene 7)
if((CLASS EQUAL 4 AND SERIES EQUAL 0) OR CLASS EQUAL 5)
    set(stream 10)
    set(return_scene 33)
endif()
