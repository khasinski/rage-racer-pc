...
endforeach()
string(FIND "${award}" "scene=19 " prize_position)
string(FIND "${award}" "scene=5 " movie_position)
string(FIND "${award}" "scene=${return_scene} " return_position)
if(NOT prize_position LESS movie_position OR NOT movie_position LESS return_position)
    message(FATAL_ERROR "Award scenes out of order: ${out}")
endif()
