...
int main(void) {
    ...
    CHECK(g_Cd.mix.ll == 127U * 4096 && g_Cd.mix.lr == 0);
    CHECK(g_Cd.mix.rr == 127U * 4096 && g_Cd.mix.rl == 0);
    ...
    SetCdVolume(63);
    CHECK(g_Cd.mix.ll == 63U * 4096 && g_Cd.mix.lr == 0);
    CHECK(g_Cd.mix.rr == 63U * 4096 && g_Cd.mix.rl == 0);
