...
unsigned char g_MsgInitCar[12] __attribute__((aligned(16))) = {0x69,0x6e,0x69,0x74,0x5f,0x63,0x61,0x72,0x0a,0x00,0x00,0x00};
unsigned char g_MsgHTbl[8] __attribute__((aligned(16))) = {0x68,0x5f,0x74,0x62,0x6c,0x0a,0x00,0x00};
unsigned char g_MsgInit0[8] __attribute__((aligned(16))) = {0x69,0x6e,0x69,0x74,0x30,0x0a,0x00,0x00};
unsigned char g_MsgInit1[8] __attribute__((aligned(16))) = {0x69,0x6e,0x69,0x74,0x31,0x0a,0x00,0x00};
unsigned char g_MsgInit1b[8] __attribute__((aligned(16))) = {0x69,0x6e,0x69,0x74,0x31,0x62,0x0a,0x00};
unsigned char g_FmtDecimalLine[8] __attribute__((aligned(16))) = {0x25,0x64,0x0a,0x00,0};
unsigned char g_MsgInit2[8] __attribute__((aligned(16))) = {0x69,0x6e,0x69,0x74,0x32,0x0a,0x00,0x00};
unsigned char g_MsgInit4[8] __attribute__((aligned(16))) = {0x69,0x6e,0x69,0x74,0x34,0x0a,0x00,0x00};
unsigned char g_MsgInit5[8] __attribute__((aligned(16))) = {0x69,0x6e,0x69,0x74,0x35,0x0a,0x00,0x00};
unsigned char g_MsgInit6[8] __attribute__((aligned(16))) = {0x69,0x6e,0x69,0x74,0x36,0x0a,0x00,0x00};
unsigned char g_FmtLongLine[8] __attribute__((aligned(16))) = {0x25,0x6c,0x64,0x0a,0x00,0x00,0x00,0x00};
unsigned char g_MsgInitOk[48] __attribute__((aligned(16))) = {0x69,0x6e,0x69,0x74,0x5f,0x6f,0x6b,0x0a,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xe4,0xe3,0x02,0x80,0x20,0xe4,0x02,0x80,0x5c,0xe4,0x02,0x80,0x78,0xe4,0x02,0x80,0xe4,0xe4,0x02,0x80,0xe4,0xe3,0x02,0x80,0x20,0xe4,0x02,0x80,0xe4,0xe4,0x02,0x80};
...
unsigned char g_LaunchEnergyThresholds[12] __attribute__((aligned(16))) = {0xc2,0x01,0x84,0x03,0xe8,0x03,0x14,0x05,0x0e,0x06,0x00,0x00};
