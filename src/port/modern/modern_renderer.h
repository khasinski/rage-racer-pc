...
/* Shared modern/enhanced-classic presentation. The compat path always runs and remains
 * the behavioural oracle; this module only changes what is presented.
 * See docs/modern_renderer_plan.md. */

#include "../port_config.h"

/* Registers the PsyZ device/present hooks for either renderer.
 * Safe to call before platform initialization.
...
/* Both presentation paths use scene capture and the shared frame pacer. */
