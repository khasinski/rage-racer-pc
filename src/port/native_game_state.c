...
Font8x8Cell g_Font8x8Cells[FONT_8X8_CELL_COUNT] = {
    {0x00, 0x00}, {0x05, 0x01}, {0x06, 0x01}, {0x07, 0x01},
    ...
    {0x08, 0x00}, {0x09, 0x00}, {0x14, 0x01}, {0x15, 0x01},
    {0x16, 0x01}, {0x17, 0x01}, {0x18, 0x01}, {0x19, 0x01},
    {0x04, 0x01}, {0x0a, 0x00}, {0x0b, 0x00}, {0x0c, 0x00},
    ...
    {0x1d, 0x00}, {0x1e, 0x00}, {0x1f, 0x00}, {0x00, 0x01},
    {0x01, 0x01}, {0x02, 0x01}, {0x03, 0x01}, {0x1b, 0x01},
    {0x1c, 0x01}, {0x1d, 0x01}, {0x1e, 0x01}, {0x1f, 0x01},
    {0x1a, 0x01}, {0x00, 0x03}, {0x01, 0x03}, {0x02, 0x03},
    {0x03, 0x03}, {0x0e, 0x00}, {0x0f, 0x00}, {0x10, 0x00},
    {0x11, 0x00}, {0x12, 0x00}, {0x13, 0x00}, {0x14, 0x00},
    {0x15, 0x00}, {0x16, 0x00}, {0x17, 0x00}, {0x18, 0x00},
    {0x19, 0x00}, {0x1a, 0x00}, {0x1b, 0x00}, {0x1c, 0x00},
    {0x1d, 0x00}, {0x1e, 0x00}, {0x1f, 0x00}, {0x00, 0x01},
