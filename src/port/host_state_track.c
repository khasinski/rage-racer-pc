...
typedef struct GameTrackCameraNode GameTrackCameraNode;
typedef struct GameTrackArcCenter GameTrackArcCenter;
typedef struct EnvironmentPalette EnvironmentPalette;
typedef union PathSceneryPositionKey PathSceneryPositionKey;
typedef union PathSceneryRotationKey PathSceneryRotationKey;
