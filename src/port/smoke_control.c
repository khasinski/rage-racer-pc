        ...
        if (length <= 0 || (size_t)length >= sizeof(path) ||
            ...
            if (g_SmokeCaptureManifest != NULL) {
                ...
                fprintf(g_SmokeCaptureManifest,
                        ...
                        (&g_RenderState)->matrix.m[0][0], (&g_RenderState)->matrix.m[0][1],
                        (&g_RenderState)->matrix.m[0][2], (&g_RenderState)->matrix.m[1][0],
                        (&g_RenderState)->matrix.m[1][1], (&g_RenderState)->matrix.m[1][2],
                        (&g_RenderState)->matrix.m[2][0], (&g_RenderState)->matrix.m[2][1],
                        (&g_RenderState)->matrix.m[2][2],
