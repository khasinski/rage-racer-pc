...
void (*g_SceneHandlers[40])(void) = {
    [SCENE_BOOT_LOGO] = UpdateBootLogoScene,
    [SCENE_FRONTEND_ENTER] = EnterFrontend,
    [SCENE_TITLE_ENTER] = EnterTitleScreen,
    [SCENE_FRONTEND] = UpdateFrontend,
    [SCENE_FMV] = UpdateFmv,
    [SCENE_MENU_ENTER] = InitMenuMode,
    [SCENE_CLASS_FMV_RETURN] = ReturnFromClassFmv,
    [SCENE_MENU] = UpdateMenuMode,
    [SCENE_ROUND_ENTER] = EnterRoundScreen,
    [SCENE_ROUND] = UpdateRoundScreen,
    [SCENE_RACE_ENTER] = EnterRaceScene,
    [SCENE_RACE] = UpdateRaceScene,
    [SCENE_LOST_RACE_ENTER] = EnterLostRaceScreen,
    [SCENE_LOST_RACE] = UpdateLostRaceScreen,
    [SCENE_RACE_END_ENTER] = EnterRaceEndScreen,
    [SCENE_RACE_END] = UpdateRaceEndScreen,
    [SCENE_REPLAY] = UpdateReplayScene,
    [SCENE_PRIZE_ENTER] = EnterPrizeScreen,
    [SCENE_PRIZE] = UpdatePrizeMoneyScreen,
    [SCENE_RECORD_ENTER] = EnterRecordEntry,
    [SCENE_RECORD] = UpdateRecordEntry,
    [SCENE_ATTRACT_ENTER] = EnterAttractScene,
    [SCENE_OPTIONS] = UpdateOptionScene,
    [SCENE_MEMORY_CARD_ENTER] = EnterMemoryCardMenu,
    [SCENE_MEMORY_CARD_LOAD_ENTER] = EnterMemoryCardMenuFromLoad,
    [SCENE_MEMORY_CARD] = UpdateMemoryCardMenu,
    [SCENE_BGM_SELECT_ENTER] = EnterBgmSelectScreen,
    [SCENE_BGM_SELECT] = UpdateBgmSelectScene,
    [SCENE_ATTRACT_DEMO_ENTER] = EnterAttractDemo,
    [SCENE_ATTRACT_DEMO] = UpdateAttractDemoScene,
    [SCENE_PROLOGUE_ENTER] = EnterPrologue,
    [SCENE_PROLOGUE] = TickPrologueStep,
    [SCENE_ENDING_FMV_RETURN] = ReturnFromEndingFmv,
    [SCENE_ENDING_STILL] = UpdateEndingStill,
};
