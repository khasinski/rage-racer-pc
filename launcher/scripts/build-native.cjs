...
run(['--build',build,'--config','Release','--parallel','6','--target','rage-save-format-tests','rage-save-generator','rage-racer','rage-extract','rage-menu-music','rage-pack','rage-save-cli','rage-mod-cli','rage-mesh-obj']);
