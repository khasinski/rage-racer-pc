...
run(['-S',root,'-B',build,...generator,'-DCMAKE_BUILD_TYPE=Release']);
run(['--build',build,'--config','Release','--parallel','6','--target','rage-save-generator','rage-racer','rage-extract','rage-pack','rage-save-cli','rage-mod-cli','rage-mesh-obj']);
