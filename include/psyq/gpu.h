 ...
 * going through the Set* helper: InitRenderState seeds RENDER_FT4_CODE and
 * RENDER_GT4_CODE, the fourth byte of the two packed GTE RGBC words the
 * handwritten EmitPolyFT4Fog / EmitPolyGT4Fog emitters copy into each packet
 * (see game/render_workspace.h).
 */
