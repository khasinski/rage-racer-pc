...
static inline const GrandPrixClassDefinition *GrandPrixContentClass(s32 index) {
    static const GrandPrixClassDefinition classes[6] = {
        {3, {0, 6},  {1, 1},   {1, 7},   {0, 0}, {1, 5}, {0, 1}},
        {3, {1, 7},  {2, 2},   {2, 8},   {0, 0}, {2, 6}, {0, 1}},
        {4, {2, 8},  {3, 3},   {3, 9},   {0, 0}, {3, 7}, {0, 1}},
        {4, {3, 9},  {4, 4},   {4, 10},  {0, 0}, {4, 8}, {0, 1}},
        {4, {4, 10}, {-1, 5},  {6, 5},   {1, 0}, {4, 8}, {0, 1}},
        {4, {5, -1}, {-1, -1}, {-1, -1}, {0, 1}, {4, 8}, {0, 0}},
    };
